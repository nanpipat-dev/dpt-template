...
import (
	...
	errmsgs "gitlab.finema.co/finema/idin-core/errmsgs"
...
func (m *BaseRepository[M]) FindAll(conds ...interface{}) ([]M, core.IError) {
	defer m.NewSession()
	list := make([]M, 0)
...
func (m *BaseRepository[M]) FindAllBatches(conds ...interface{}) ([]M, core.IError) {
	defer m.NewSession()
	list := make([]M, 0)
	...
	if err.Error != nil {
		return nil, m.ctx.NewError(err.Error, errmsgs.DBError)
	}

	return list, nil
}

func (m *BaseRepository[M]) FindBatchs() ([]M, core.IError) {
	defer m.NewSession()
	lists := make([]M, 0)
	batchSize := 30000
	offset := 0
...
func (m *BaseRepository[M]) FindOne(conds ...interface{}) (*M, core.IError) {
	defer m.NewSession()
	item := new(M)
...
func (m *BaseRepository[M]) Create(values interface{}) core.IError {
	defer m.NewSession()
...
func (m *BaseRepository[M]) Update(values interface{}) core.IError {
	defer m.NewSession()
	var err error
	if m.isForceUpdate {
...
func (m *BaseRepository[M]) Delete(conds ...interface{}) core.IError {
	defer m.NewSession()
	item := new(M)
...
func (m *BaseRepository[M]) HardDelete(conds ...interface{}) core.IError {
	defer m.NewSession()
	item := new(M)
...
func (m *BaseRepository[M]) Sum(column string) (int64, core.IError) {
	var sum int64
...
func (m *BaseRepository[M]) Upsert(values interface{}) core.IError {
	defer m.NewSession()
	old := *m
...
func (m *BaseRepository[M]) Set(values interface{}) core.IError {
	defer m.NewSession()
	model := new(M)
